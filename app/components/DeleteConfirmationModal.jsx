    ...
    <div className="fixed inset-0 z-[120] flex items-center justify-center p-4 bg-background/90 backdrop-blur-sm animate-fade-in">
      <div className="relative w-full max-w-md bg-modal-background rounded-lg p-2  shadow-[0_0_50px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col">
        ...
        <div className="p-6 border-b border-white/5 flex items-start gap-4">
          <div className="w-12 h-12 rounded-full bg-red-400 border border-error-container/20 flex items-center justify-center flex-shrink-0">
            <span className="material-symbols-outlined text-error-container text-2xl">
              warning
            </span>
          </div>
          <div>
            <h4 className="text-2xl text-red-400 font-black font-headline uppercase tracking-wider">
              Archive {itemType}
            </h4>
          </div>
        </div>
        ...
        <div className="p-6 border-t border-white/5 flex gap-3 justify-end">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={isDeleting}
            className="px-6 py-2.5 rounded-lg text-sm font-bold bg-red-400 hover:scale-105 text-black/90 transition-all flex items-center gap-2 disabled:opacity-50"
          >
            {isDeleting ? (
              <>
