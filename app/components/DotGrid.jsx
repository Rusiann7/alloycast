...
const DotGrid = ({
  ...
  useEffect(() => {
    ...
    const id = requestAnimationFrame(() => {
      setResolvedColors({
        base: resolveColor(baseColor),
        active: resolveColor(activeColor)
      });
    });

    return () => cancelAnimationFrame(id);
  }, [baseColor, activeColor, theme]);
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      const baseRgb = resolvedColors.base;
      const activeRgb = resolvedColors.active;
