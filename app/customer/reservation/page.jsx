  ...
  return (
    <div className="bg-background font-body text-on-surface min-h-screen flex items-center justify-center p-6 radial-brand overflow-hidden">
      ...
      <div className="relative z-10 max-w-xl w-full text-center animate-fade-in">
        ...
        <div
          className="inline-block px-4 py-1.5 bg-secondary-fixed text-on-secondary-fixed text-[10px] font-black uppercase tracking-[0.4em] mb-4 italic animate-slide-in-up"
        ...
        <h1
          className="font-headline font-black text-4xl lg:text-6xl uppercase italic tracking-tighter leading-[0.9] mb-4 animate-slide-in-up"
        ...
        <p
          className="text-sm font-light text-[#A8A8A0] max-w-md mx-auto mb-12 animate-slide-in-up"
          style={{ animationDelay: "400ms" }}
        >
          Your R34 Skyline GTR reservation has been successfully confirmed.
          Check your account for collection details.
        </p>

        <div
          className="grid grid-cols-2 gap-4 animate-slide-in-up"
          style={{ animationDelay: "500ms" }}
        >
          <div className="bg-surface-container-high border border-white/5 p-6 rounded-lg text-left">
            <p className="text-[10px] font-black uppercase text-[#555555] mb-2 tracking-widest leading-none">
              Status
            </p>
